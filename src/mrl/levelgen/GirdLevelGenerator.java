...
public class GirdLevelGenerator extends LevelGenerator {
	...
	public MLevel generateLevel(Position size, int startIndex, int endIndex, int roomWidth, int roomHeight) throws CRLException{
	...
	private MLevel plotLevel() throws CRLException{
