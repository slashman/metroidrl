...
public class PrizeRoom extends Feature {
	protected int width, height;
	private String floor, prize;
	...
	public PrizeRoom(int width, int height, String floor, String prize) {
	...
	public boolean drawOverCanvas(String[][] canvas, Position where, int direction, boolean [][] mask, ArrayList hotspots){
		...
		canvas[start.x+midWidth][start.y+midHeight] = floor +" FEATURE "+prize;
