...
public class CharCuts {
	...
	private Hashtable hashCuts = new Hashtable();
	{
		...
		temp.add("Melduck", ". . . wait . . . I hear something... I fear things will get ugly...");
		temp.add("Melduck", "Petra is to the northwest, and the castle of Dracula is east of here... we better proceed on foot... but quickly.");
